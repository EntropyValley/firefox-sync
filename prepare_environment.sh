...
# mariadb server
DEFAULT_MARIADB_SERVER='localhost'
read -e -p "MariaDB/MySQL server [${DEFAULT_MARIADB_SERVER}]: " MARIADB_SERVER
MARIADB_SERVER=${MARIADB_SERVER:-${DEFAULT_MARIADB_SERVER}}

# mariadb server port
DEFAULT_MARIADB_SERVER_PORT=3306
read -e -p "MariaDB/MySQL port [${DEFAULT_MARIADB_SERVER_PORT}]: " MARIADB_SERVER_PORT
MARIADB_SERVER_PORT=${MARIADB_SERVER_PORT:-${DEFAULT_MARIADB_SERVER_PORT}}

# mariadb username
DEFAULT_MARIADB_USER='username'
read -e -p "MariaDB/MySQL username [${DEFAULT_MARIADB_USER}]: " MARIADB_USER
MARIADB_USER=${MARIADB_USER:-${DEFAULT_MARIADB_USER}}

# mariadb password
DEFAULT_MARIADB_PASSWORD='password'
read -e -p "MariaDB/MySQL password [${DEFAULT_MARIADB_PASSWORD}]: " MARIADB_PASSWORD
MARIADB_PASSWORD=${MARIADB_PASSWORD:-${DEFAULT_MARIADB_PASSWORD}}

# mariadb server syncstorage database
DEFAULT_MARIADB_SYNCSTORAGE_DATABASE='firefox_syncstorage'
read -e -p "MariaDB/MySQL SyncStorage DB Name [${DEFAULT_MARIADB_SYNCSTORAGE_DATABASE}]: " MARIADB_SYNCSTORAGE_DATABASE
MARIADB_SYNCSTORAGE_DATABASE=${MARIADB_SYNCSTORAGE_DATABASE:-${DEFAULT_MARIADB_SYNCSTORAGE_DATABASE}}

# mariadb server tokenserver database
DEFAULT_MARIADB_TOKENSERVER_DATABASE='firefox_tokenserver'
read -e -p "MariaDB/MySQL TokenServer DB Name [${DEFAULT_MARIADB_TOKENSERVER_DATABASE}]: " MARIADB_TOKENSERVER_DATABASE
MARIADB_TOKENSERVER_DATABASE=${MARIADB_TOKENSERVER_DATABASE:-${DEFAULT_MARIADB_TOKENSERVER_DATABASE}}
...
apply_sed ${SCRIPT_DIR}/.env "s|MARIADB_SERVER=.*|MARIADB_SERVER=${MARIADB_SERVER}|"
apply_sed ${SCRIPT_DIR}/.env "s|MARIADB_SERVER_PORT=.*|MARIADB_SERVER_PORT=${MARIADB_SERVER_PORT}|"
apply_sed ${SCRIPT_DIR}/.env "s|MARIADB_SYNCSTORAGE_DATABASE=.*|MARIADB_SYNCSTORAGE_DATABASE=${MARIADB_SYNCSTORAGE_DATABASE}|"
apply_sed ${SCRIPT_DIR}/.env "s|MARIADB_TOKENSERVER_DATABASE=.*|MARIADB_TOKENSERVER_DATABASE=${MARIADB_TOKENSERVER_DATABASE}|"
apply_sed ${SCRIPT_DIR}/.env "s|MARIADB_USER=.*|MARIADB_USER=${MARIADB_USER}|"
apply_sed ${SCRIPT_DIR}/.env "s|MARIADB_PASSWORD=.*|MARIADB_PASSWORD=${MARIADB_PASSWORD}|"
